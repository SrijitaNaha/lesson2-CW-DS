...
class SUV(Car):
    def __init__(self, brand, model, fuel, color, transmission, turbo):
        super().__init__(brand, model, fuel, color)  # Use super() instead of Car.__init__
...
# print(pulkit.__password)  # This will raise an AttributeError because __password is private
